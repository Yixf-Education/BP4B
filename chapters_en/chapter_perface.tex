...
\markboth{Perface}{What Is Bioinformatics?}
...
\markboth{Perface}{What Bioinformatics Can Do}
...
\markboth{Perface}{About This Book}
...
\markboth{Perface}{Who This Book Is For}
...
\markboth{Perface}{Why Should I Learn to Program?}
...
\markboth{Perface}{Structure of This Book}
...
\markboth{Perface}{Conventions Used in This Book}
...
%\shadowbox{
%\parpic[l]{
%\includegraphics[width=2em]{../figures/note.png}
...
%\shadowbox{
%\parpic[l]{
%\includegraphics[width=2em]{../figures/warning.png}
...
\begin{table}[h]
  \begin{center}
    \begin{tabu} to 0.85\linewidth {|X[1,r,m]X[15,l,m]|}
      \tabucline{-}
      \includegraphics[width=1cm]{note.png} & This icon designates a warning relating to the nearby text.\\
      \tabucline{-}
    \end{tabu}
  \end{center}
\end{table}
...
\begin{table}[h]
  \begin{center}
    \begin{tabu} to 0.85\linewidth {|X[1,r,m]X[15,l,m]|}
      \tabucline{-}
      \includegraphics[width=1.1cm]{warning.png} & This icon designates a note, which is an important aside to the nearby text.\\
      \tabucline{-}
    \end{tabu}
  \end{center}
\end{table}
...
\markboth{Perface}{Comments and Questions}
...
\markboth{Perface}{Acknowledgments}
