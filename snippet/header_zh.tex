...
%\SetWatermarkText{译文初稿}%设置水印文字
%\SetWatermarkText{Manuscript}%设置水印文字
%\SetWatermarkLightness{0.9}%设置水印亮度
%\SetWatermarkScale{0.9}%设置水印大小
%\makeatletter
...
%\newwatermark[allpages,color=gray!15,angle=45,scale=5,xpos=-10,ypos=-20]{译文初稿}
